...
public class Order {
  ...
  public static Order createNewWith(UUID id, UUID accountId, String description, EStatus status, BigDecimal total) {
  ...
  public static Order createNewWith(UUID accountId, String description, EStatus status, BigDecimal total) {
    return Order.builder()
      .accountId(accountId)
      .description(description)
      .status(status)
